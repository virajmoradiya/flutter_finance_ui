...
class LiteRollingSwitch extends StatefulWidget {
  ...
  LiteRollingSwitch({
    ...
    this.iconOnColor = Colors.green,
    this.iconOffColor = Colors.green,
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  child: Text(
                    widget.textOff,
                    style:
                        TextStyle(color: widget.textOffColor, fontWeight: FontWeight.bold, fontSize: widget.textSize),
                  ),
                ),
              ),
            ),
